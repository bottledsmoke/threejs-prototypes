...
export default function Model({ ...props }: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/Room_v2.glb') as GLTFResult
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[-1.65, 0, -0.05]} rotation={[-Math.PI / 2, 0, 1.76]}>
        <group position={[0, 0, 0.22]} rotation={[-Math.PI / 2, -0.23, Math.PI]} scale={[1, 1.08, 1]}>
          <group position={[0.38, 0.53, 0.05]}>
            <mesh geometry={nodes.Armrest_R.geometry} material={nodes.Armrest_R.material} />
          </group>
          <group position={[-0.31, 0.53, 0.08]}>
            <mesh geometry={nodes.Armrest_R003.geometry} material={nodes.Armrest_R003.material} />
          </group>
        </group>
        <group position={[0, 0, 0.3]} rotation={[-Math.PI / 2, -0.23, Math.PI]}>
          <group position={[0.27, 0.4, -0.13]} rotation={[-0.3, 0.52, 0.15]}>
            <group position={[0, 0.04, 0.23]}>
              <mesh geometry={nodes.Armrest_R001.geometry} material={nodes.Armrest_R001.material} />
            </group>
            <mesh geometry={nodes.Cube003.geometry} material={nodes.Cube003.material} />
            <mesh geometry={nodes.Cube009.geometry} material={nodes.Cube009.material} position={[0, -0.02, 0.11]} />
            <mesh geometry={nodes.Cube010.geometry} material={nodes.Cube010.material} position={[0, -0.02, 0.11]} />
          </group>
          <group position={[-0.27, 0.4, -0.13]} rotation={[-0.23, -0.16, -0.04]}>
            ...
            />
            <mesh geometry={nodes.Cube004.geometry} material={nodes.Cube004.material} position={[0, 0, 0.11]} />
            <mesh geometry={nodes.Cube005.geometry} material={nodes.Cube005.material} position={[0, -0.02, 0.12]} />
            <mesh geometry={nodes.Cube007.geometry} material={nodes.Cube007.material} position={[0, 0, 0.22]} />
          </group>
          ...
          />
          <mesh geometry={nodes.Arms.geometry} material={nodes.Arms.material} position={[0, 0.27, -0.13]} />
          <mesh
          ...
          />
          <mesh geometry={nodes.Seat001.geometry} material={nodes.Seat001.material} position={[0, 0.18, 0.03]} />
          <mesh geometry={nodes.Seat002.geometry} material={nodes.Seat002.material} position={[0, 0.18, 0.03]} />
          <mesh
      ...
      <mesh
        ...
        rotation={[0, 0, -Math.PI / 2]}>
        <mesh geometry={nodes.Plane041.geometry} material={nodes.Plane041.material} />
        <mesh
